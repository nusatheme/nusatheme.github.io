...
![categories list](/img/oenzy/categories-list.jpg)
...
- Example output:  
  ```html
  <ul class="wp-block-oenzy-category-list">
...
- Developers can target `.wp-block-oenzy-category-list` and `.cat-item` for custom styling.
