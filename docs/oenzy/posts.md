...
# Posts
The **Oenzy** theme offers multiple layout options for single blog posts. Each layout is designed to enhance readability while giving your content a unique style. You can select your preferred layout when creating or editing a post.
...
![post default template](/img/oenzy/post-default-template.jpg)
...
![post full width template](/img/oenzy/post-full-width-template.jpg)
...
![post hero overlay template](/img/oenzy/post-hero-overlay-template.jpg)
...
![post hero split template](/img/oenzy/post-hero-split-template.jpg)