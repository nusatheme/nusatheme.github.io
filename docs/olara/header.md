...
The **Olara** theme includes multiple header template parts that work together to create a flexible and responsive navigation system. Each template part serves a specific purpose, but they all share the same core elements such as the logo and primary navigation.  
...
![headers in template](/img/olara/headers-in-template.webp)
...
![header](/img/olara/header-main.jpg)
...
![sticky header](/img/olara/header-sticky.jpg)
...
![mobile header](/img/olara/header-mobile.jpg)
