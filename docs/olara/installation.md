...
## Theme Requirements
To install and use this theme, ensure your WordPress site meets the following requirements: **WordPress version 6.5** or higher and **PHP version 8.1** or above. 
...
![installation step 1](/img/olara/installation-step-1.webp)
...
![installation step 2](/img/olara/installation-step-2.webp)
...
![installation step 4](/img/olara/installation-step-4.jpg)
...
- **Olara Core**<br/>
  Installing the **Olara Core** plugin is essential for using this theme’s custom blocks. This core plugin provides a variety of custom blocks that add functionality and design options to your site. Without it, the custom blocks won’t be available. 
...
- **[Query Loop Load More](https://wordpress.org/plugins/query-loop-load-more/)** <br/>
  Query Loop Load More is a lightweight WordPress plugin that adds a “Load More” button to the Query Loop block, allowing visitors to load additional posts without reloading the page. It helps create smoother archive and blog layouts, improves browsing experience, and works well with block themes and custom post listings.

![install required plugins](/img/olara/install-required-plugin.webp)

:::info
The **Icon Block** plugin is required for many Olara block patterns. Please install and activate it to ensure patterns display correctly. This plugin requires **WordPress 6.5 or higher**. Please ensure your site is running WordPress version 6.5+ before installing.

**Ninja Form** is used to show contact form in the page contact, so if you're not planning to add contact form to your page or you want to use other plugin for your form, it's not necessary to install this plugin.

**One Click Demo Import** plugin is required to import the demo content for **Olara**. If you prefer to set up your site manually, you don’t need to install this plugin.
:::
<br/>

## Demo Content
To help you get started quickly, **Olara** includes demo content that you can import with just a few clicks. This will make your site look similar to the theme demo, so you can start customizing right away.
...
2. Choose the homepage demo you want to import, then click  **Import** to start the import process.  
...
### After Import
- Your site should now look similar to the **Olara demo**.  
