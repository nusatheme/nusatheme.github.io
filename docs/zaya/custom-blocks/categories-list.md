...
![categories list](/img/zaya/categories-list.jpg)
...
- Example output:  
  ```html
  <ul class="wp-block-zaya-category-list">
...
- Developers can target `.wp-block-zaya-category-list` and `.cat-item` for custom styling.
