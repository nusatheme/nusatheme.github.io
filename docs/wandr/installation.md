...
![installation step 1](/img/wandr/installation-step-1.webp)
...
![installation step 2](/img/wandr/installation-step-2.webp)
...
![installation step 4](/img/wandr/installation-step-4.jpg)
...
- **Wandr Core**<br/>
  Installing the **Wandr Core** plugin is essential for using this theme’s custom blocks. This core plugin provides a variety of custom blocks that add functionality and design options to your site. Without it, the custom blocks won’t be available. Learn more about the features it provides on this [custom blocks page](/docs/category/custom-blocks-2).
...
![install required plugins](/img/wandr/install-required-plugin.jpg)

:::info
The **Icon Block** plugin is required for many Wandr block patterns. Please install and activate it to ensure patterns display correctly. This plugin requires **WordPress 6.5 or higher**. Please ensure your site is running WordPress version 6.5+ before installing.
...
**One Click Demo Import** plugin is required to import the demo content for **Wandr**. If you prefer to set up your site manually, you don’t need to install this plugin.
:::
<br/>

## Demo Content
To help you get started quickly, **Wandr** includes demo content that you can import with just a few clicks. This will make your site look similar to the theme demo, so you can start customizing right away.
...
### After Import
- Your site should now look similar to the **Wandr demo**.  
