...
![categories list](/img/vara/categories-list.jpg)
...
- Example output:  
  ```html
  <ul class="wp-block-vara-category-list">
...
- Developers can target `.wp-block-vara-category-list` and `.cat-item` for custom styling.
