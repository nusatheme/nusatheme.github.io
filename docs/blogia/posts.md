...
# Posts
The **Blogia** theme offers multiple layout options for single blog posts. Each layout is designed to enhance readability while giving your content a unique style. You can select your preferred layout when creating or editing a post.
...
![post default template](/img/blogia/post-default-template.jpg)
...
![post full width template](/img/blogia/post-full-width-template.jpg)
...
![post hero overlay template](/img/blogia/post-hero-overlay-template.jpg)
...
![post hero split template](/img/blogia/post-hero-split-template.jpg)