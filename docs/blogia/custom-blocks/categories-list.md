...
![categories list](/img/blogia/categories-list.jpg)
...
- Example output:  
  ```html
  <ul class="wp-block-blogia-category-list">
...
- Developers can target `.wp-block-blogia-category-list` and `.cat-item` for custom styling.
