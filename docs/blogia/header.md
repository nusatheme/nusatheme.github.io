...
The **Blogia** theme includes multiple header template parts that work together to create a flexible and responsive navigation system. Each template part serves a specific purpose, but they all share the same core elements such as the logo and primary navigation.  
...
![header](/img/blogia/header-parts.jpg)
...
![header](/img/blogia/header-main.jpg)
...
![sticky header](/img/blogia/header-sticky.jpg)
...
![mobile header](/img/blogia/header-mobile.jpg)
